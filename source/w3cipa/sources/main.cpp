...
int main() {
    ...
    w3c::voiceinteraction::ipa::external::providerselectionservice::ReferenceProviderSelectionService providerSelectionService;
    ...
    std::string input("Say hello to the universe");
    ...
    std::shared_ptr<ClientResponse> response = providerSelectionService.processInput(nullptr, nullptr, nullptr, multiModalInputs, nullptr);
